...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TrialProgress) DeepCopyInto(out *TrialProgress) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrialProgress.
func (in *TrialProgress) DeepCopy() *TrialProgress {
	if in == nil {
		return nil
	}
	out := new(TrialProgress)
	in.DeepCopyInto(out)
	return out
}
